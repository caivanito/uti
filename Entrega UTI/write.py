...
def WriteXLSX(path, file, lst, file_output, path_db):
    full_file = path + file # PATH DEL ARCHIVO TEMPLATE
    sheet_template = 'Estadística nueva' # HOJA ESTADISTICA NUEVA

    if Exist_File(file_output): # COMPRUEBA SI EXISTE EL ARCHIVO OUTPUT
    ...
    try:
        ...
        if sh is not None:
            ...
            print('Imposible identificar hoja ' + sheet_template + ' en libro: ' + file)
